...
export const skillFrontend: Skill[] = [
    ...
    { name: "Thymeleaf", icon: 'devicon:thymeleaf' },
    { name: "Next.js", icon: 'skill-icons:nextjs-dark' },
    { name: "Jest (Testing)", icon: 'skill-icons:jest' },
    { name: "Pug (Templating Engine)", icon: 'skill-icons:pug-dark' },
    { name: "Rest", icon: 'skill-icons:rest-api' },
    { name: "Restful API", icon: 'skill-icons:restful-api' },
...
export const skillTools: Skill[] = [
    ...
    { name: "Perforce", icon: 'skill-icons:perforce' },
